/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 52794340518a5da150dbebf69a5de7cc)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		CONFIG_ENCRYPTION_KEY: "dev-only-change-before-production";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "VALUE_FROM_CLOUDFLARE" | "CONFIG_ENCRYPTION_KEY">> {}
}
